      ...
      <div class="auth-container slide-up">
        ...
        <div class="auth-branding d-none d-lg-flex">
          <div class="branding-content">
            <h2 class="branding-title">Join thousands on<br><span class="title-gradient">N4Booking</span></h2>
            <p class="branding-subtitle">Start booking meeting rooms in seconds. No credit card required.</p>
        ...
        <div class="auth-form-container">
          <v-card theme="dark" class="auth-card" elevation="0" rounded="xl">
            <div class="text-center mb-6">
              ...
              <h1 class="text-h4 font-weight-bold text-white mb-2">Create Account</h1>
              <p class="text-grey-lighten-1">Get started for free today</p>
            </div>
