    ...
    <v-main class="position-relative z-index-1">
      <v-container class="py-8">
        ...
        <div class="welcome-banner mb-8">
          <div class="welcome-content">
            <div class="welcome-text">
              ...
              <p class="welcome-subtitle">Ready to book your next meeting? Find the perfect room below.</p>
            </div>
            ...
            <v-card theme="dark" elevation="0" class="stat-card fill-height bg-glass" rounded="xl">
              <v-card-text class="pa-5">
                <div class="d-flex align-center mb-4">
                  ...
                  <v-chip color="success" size="small" variant="tonal" class="ml-auto">Live</v-chip>
                </div>
                <div class="text-h3 font-weight-bold text-white mb-1">{{ stats.availableRooms || 0 }}</div>
                <div class="text-body-2 text-medium-emphasis">Available Rooms</div>
              </v-card-text>
            </v-card>
          </v-col>
          <v-col cols="12" md="4">
            <v-card theme="dark" elevation="0" class="stat-card fill-height bg-glass" rounded="xl">
              <v-card-text class="pa-5">
                <div class="d-flex align-center mb-4">
                  ...
                  <v-chip color="warning" size="small" variant="tonal" class="ml-auto">Now</v-chip>
                </div>
                <div class="text-h3 font-weight-bold text-white mb-1">{{ stats.activeBookings || 0 }}</div>
                <div class="text-body-2 text-medium-emphasis">Active Meetings</div>
              </v-card-text>
            </v-card>
          </v-col>
          <v-col cols="12" md="4">
            <v-card theme="dark" elevation="0" class="stat-card fill-height bg-glass" rounded="xl">
              <v-card-text class="pa-5">
                <div class="d-flex align-center mb-4">
                  ...
                  <v-chip color="info" size="small" variant="tonal" class="ml-auto">Today</v-chip>
                </div>
                <div class="text-h3 font-weight-bold text-white mb-1">{{ stats.confirmedBookingsToday || 0 }}</div>
                <div class="text-body-2 text-medium-emphasis">Scheduled Today</div>
              </v-card-text>
            </v-card>
          </v-col>
        </v-row>
        ...
        <div class="d-flex justify-space-between align-center mb-6">
            <h2 class="text-h5 font-weight-bold text-white">Conference Rooms</h2>
             ...
             <v-row dense align="center">
               ...
               <v-col cols="12" md="2">
                ...
                <v-col cols="12" md="3" class="d-flex gap-2">
                  <v-btn color="primary" prepend-icon="mdi-magnify" type="submit" class="flex-grow-1" height="40">Search</v-btn>
                  <v-btn variant="outlined" color="grey" @click="clearFilters" height="40">Clear</v-btn>
                </v-col>
             </v-row>
           </v-form>
         </v-card>
             ...
             <v-hover v-slot="{ isHovering, props }">
              ...
              >
                 ...
                 <v-card-actions class="pa-4 pt-0">
                    ...
                    >
                        {{ room.status === 'Occupied' ? 'Unavailable' : 'Book Room' }}
                    </v-btn>
                 </v-card-actions>
              </v-card>
            </v-hover>
