  ...
  <div class="profile-wrapper">
    ...
    <v-app-bar flat color="transparent" class="px-md-4 border-bottom bg-glass-nav">
      ...
      <template v-if="$vuetify.display.mdAndUp">
        <v-btn to="/dashboard" variant="text" color="white" class="nav-btn">{{ $t('nav.home') }}</v-btn>
        <v-btn to="/calendar" variant="text" color="white" class="nav-btn">{{ $t('nav.calendar') }}</v-btn>
        <v-btn to="/my-bookings" variant="text" color="white" class="nav-btn">{{ $t('nav.myBookings') }}</v-btn>
      </template>
    ...
    <v-main class="position-relative z-index-1">
      <v-container class="py-8" style="max-width: 800px;">
        <h1 class="text-h4 font-weight-bold text-white mb-6">{{ $t('profile.title') }}</h1>
              ...
              <v-row>
                <v-col cols="12" md="6">
                  <v-text-field
                    ...
                    variant="outlined"
                    color="primary"
                    :rules="[v => !!v || $t('profile.firstNameRequired')]"
                ...
                <v-col cols="12" md="6">
                  <v-text-field
                    ...
                    variant="outlined"
                    color="primary"
                    :rules="[v => !!v || $t('profile.lastNameRequired')]"
                    prepend-inner-icon="mdi-account"
                  ></v-text-field>
                </v-col>
              </v-row>
            ...
            <v-form @submit.prevent="handleChangePassword" v-model="passwordFormValid">
              ...
              <v-text-field
                ...
                :rules="[
                  ...
                  v => v.length >= 6 || $t('profile.passwordMinLength')
                ]"
              ...
              <v-text-field
                ...
                :rules="[
                  ...
                  v => v === passwordForm.newPassword || $t('profile.passwordsMismatch')
                ]"
