      ...
      <div class="auth-container slide-up">
        ...
        <div class="auth-branding d-none d-lg-flex">
          <div class="branding-content">
            <h2 class="branding-title">Welcome back to<br><span class="title-gradient">N4Booking</span></h2>
            <p class="branding-subtitle">The smartest way to manage your workspace meetings. Book rooms in seconds.</p>
            
            <div class="branding-features">
              <div class="feature-item">
                <v-icon icon="mdi-check-circle" color="success" size="20"></v-icon>
                <span>Instant room booking</span>
              </div>
              <div class="feature-item">
                <v-icon icon="mdi-check-circle" color="success" size="20"></v-icon>
        ...
        <div class="auth-form-container">
          <v-card theme="dark" class="auth-card" elevation="0" rounded="xl">
            <div class="text-center mb-8">
              ...
              <h1 class="text-h4 font-weight-bold text-white mb-2">Sign In</h1>
              <p class="text-grey-lighten-1">Enter your credentials to continue</p>
            </div>
            ...
            <div class="text-center text-body-2 text-grey">
              ...
              <router-link to="/register" class="text-primary font-weight-bold text-decoration-none">Create one free</router-link>
            </div>
          </v-card>
        </div>
      </div>
